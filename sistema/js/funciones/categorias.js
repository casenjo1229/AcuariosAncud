function load(page){
    ...
    $('#dataDelete').on('show.bs.modal', function (event) {
        ...
        var modal = $(this)
        modal.find('.modal-body #id').val(id)
        modal.find('.modal-body #cat').text(categoria)
    })
    ...
    $( "#guardarDatos" ).submit(function( event ) {
        ...
        $.ajax({
          type: "POST",
          url: "php/acciones/add/add_categoria.php",
          data: data,
          processData: false,
          contentType: false,
          cache: false,
    ...
    $( "#actualidarDatos" ).submit(function( event ) {
        ...
        $.ajax({
          type: "POST",
          url: "php/acciones/update/update_categoria.php",
          data: data,
          processData: false,
          contentType: false,
          cache: false,
    ...
    $( "#eliminarDatos" ).submit(function( event ) {
        var parametros = $(this).serialize();
             $.ajax({
                    type: "POST",
                    url: "php/acciones/delete/delete_categoria.php",
                    data: parametros,
                     beforeSend: function(objeto){
                        $(".datos_ajax_delete").html("Mensaje: Cargando...");
                      },
