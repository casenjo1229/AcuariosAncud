...
<body>
                ...
                <div class="form-group">
                    <div class="d-flex align-items-end e9">
                        <div class="col-4 p-0 e5">
                            ...
                            <select class="selectpicker form-control" data-live-search="true" name="codigo" id="codigo" onchange="load(1);">
                                <?php 
                                    $consulta = "call consuta_productos_todos()";
  ...
  <script src="js/funciones/tarjeta.js"></script>
