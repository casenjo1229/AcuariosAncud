                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control" name="categoria0" id="categoria0">
                            </div>
                        </div>
                    </div>
...
<form id="eliminarDatos">
    <div class="modal fade" id="dataDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="id" name="id">
                    <p>Esta acción eliminará de forma permanente la siguiente categoria:</p>
                    <b id="cat"></b>
  ...
  <script src="js/funciones/categorias.js"></script>
