...
<body>
    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-between espac">
            ...
            <div class="col-12 col-lg-4 desta d-flex align-items-center flex-column expor">
                <h1 class="pt-2">Exportar</h1>
                <div class="form-group mt-3 mb-0">
                    <a href="php/acciones/search/reporte_fechas.php" target="_blank" class="btn btn-primary w-100">Reporte</a>
                </div>
                <div class="form-group mt-1">
                    <a href="php/acciones/search/reporte_caja.php" target="_blank" class="btn btn-primary w-100">Caja Chica</a>
                </div>
            </div>
        </div>
