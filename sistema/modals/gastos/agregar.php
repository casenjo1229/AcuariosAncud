                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control" name="numero0" id="numero0">
                            </div>
                            <div class="form-group mb-0">
                                <label class="col-form-label">Descripción:</label>
                                <input type="text" class="form-control" name="descripcion0" id="descripcion0">
                            </div>
                            <div class="form-group mb-0">
                                <label class="col-form-label">Total:</label>
                                <input type="text" class="form-control" name="total0" id="total0">
                            </div>
                        </div>
                    </div>
