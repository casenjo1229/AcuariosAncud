<?php
    ...
    while ($campo = mysqli_fetch_array( $result ))
    {
        ...
        {
            $consulta = "call consulta_sub_menu($campo[id_menu])";
            ...
            while ($campo1 = mysqli_fetch_array( $result1 ))
            {
                ...
                if ($columna = mysqli_fetch_array( $resultado ))
                {
                    ...
                    $query="UPDATE accesos SET acceso=$test1[1],agregar=$test1[2],editar=$test1[3],eliminar=$test1[4],fec_edicion='$fecha',id_usuario_edicion=$id_usuario where id_usuario_acceso=$_POST[usuario] and id_menu = $campo1[id_registro] and sub_menu=1";
            ...
            if ($columna = mysqli_fetch_array( $resultado ))
            {
                ...
                $query="UPDATE accesos SET acceso=$test[1],agregar=$test[2],editar=$test[3],eliminar=$test[4],fec_edicion='$fecha',id_usuario_edicion=$id_usuario where id_usuario_acceso=$_POST[usuario] and id_menu = $campo[id_menu]";
                if (conectar()->query($query) === TRUE) {
                    $messages[] = "Acceso guardado satisfactoriamente.";
                }
            }
